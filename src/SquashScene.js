...
SquashScene.prototype.init = function(cb){
    ...
    this.squashEffect = new THREE.ShaderPass(THREE.SquashShader);
    this.squashEffect.renderToScreen = true;

    this.composer.addPass(this.squashEffect);

    this.reset();
    cb();
}

SquashScene.prototype.reset = function(){
...
SquashScene.prototype.update = function(){
    var length = 500;
    var lightoffset = 190;
    ...
    */
    ...
    this.squashEffect.uniforms.amount.value = (Math.sin(t/1000) > 0.5 ? 1 : 0);

}

SquashScene.prototype.render = function(){
